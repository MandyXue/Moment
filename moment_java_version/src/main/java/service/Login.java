...
public class Login {
    public void loginTest()throws Exception {
        ...
        String path = "https://api.leancloud.cn/1.1/login";
        ...
        String[] paramVal={"liuyang","123456"};
        OutputStream out = conn.getOutputStream();
        Writer writer = new OutputStreamWriter(out, encoding);
        myencodeMethod(writer, paramName, paramVal, encoding);
        writer.close();
        out.flush();
        out.close();
    ...
    static public void myencodeMethod(Writer writer, String[] paramName, String[] paramVal, String encoding)throws Exception {
        for(int i=0;i< paramName.length;i++){
            writer.write(URLEncoder.encode(paramName[i],encoding));
            writer.write("=");
            writer.write(URLEncoder.encode(paramVal[i], encoding));
            writer.write("&");
        }
    }
}
